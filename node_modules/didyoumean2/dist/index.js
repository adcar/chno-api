 ...
 */
var didYouMean = function (input, matchList, options) {
    /*+++++++++++++++++++
     + Initiate options +
     +++++++++++++++++++*/
    var optionsWithDefaults = fillDefaultOptions_1.default(options);
    ...
    /*++++++++++++++++++++
     + Deal with options +
     ++++++++++++++++++++*/
    var normalizedInput = normalizeString_1.default(input, optionsWithDefaults);
    ...
    switch (thresholdType) {
        case ThresholdTypeEnums_1.ThresholdTypeEnums.EDIT_DISTANCE:
            ...
            scoreProcessor = function (matchItem) {
                return leven_1.default(normalizedInput, matchItemProcessor_1.default(matchItem, optionsWithDefaults));
            };
            break;
        case ThresholdTypeEnums_1.ThresholdTypeEnums.SIMILARITY:
            checkIfMatched = function (score) { return score >= threshold; };
            scoreProcessor = function (matchItem) {
                return getSimilarity_1.default(normalizedInput, matchItemProcessor_1.default(matchItem, optionsWithDefaults));
            };
            break;
    ...
    /*+++++++++++++++++++++++
     ...
     +++++++++++++++++++++++*/
    return resultProcessor_1.default(matchList, matchedIndexes, returnType);
};
